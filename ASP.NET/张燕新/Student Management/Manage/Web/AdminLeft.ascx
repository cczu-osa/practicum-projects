...
<asp:TreeView ID="TreeView1" runat="server" ShowLines="True">
	<Nodes>
		<%--<asp:TreeNode Text="个人信息" Value="个人信息" NavigateUrl="~/A_info.aspx"></asp:TreeNode>--%>
		...
		<asp:TreeNode Text="课程管理" Value="课程管理">
			<asp:TreeNode NavigateUrl="~/A_AddCourse.aspx" Text="添加课程" Value="添加课程"></asp:TreeNode>
			<asp:TreeNode NavigateUrl="~/A_ChangeCourse.aspx" Text="课程信息维护" Value="课程信息维护"></asp:TreeNode>
		</asp:TreeNode>
